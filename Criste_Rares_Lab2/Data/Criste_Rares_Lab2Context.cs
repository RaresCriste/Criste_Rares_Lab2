...
namespace Criste_Rares_Lab2.Data
{
    public class Criste_Rares_Lab2Context : DbContext
    {
        ...
        public DbSet<Criste_Rares_Lab2.Models.Category>? Category { get; set; }

        public DbSet<Criste_Rares_Lab2.Models.Member>? Member { get; set; }

        public DbSet<Criste_Rares_Lab2.Models.Borrowing>? Borrowing { get; set; }
    }
}
